...
export default function TicketsPage() {
  const { storeID, email, tickets, loading, error: syncError, now, refresh: loadTickets } = useDashboard();
  ...
  const updateStatus = async (ticketID: string, newState: TicketStatus) => {
    ...
    try { const result = await changeTicketState(storeID, ticketID, newState); if (!result.success) throw new Error(result.message); await loadTickets(); }
